package net.gray.spiceoflifemod.blocks;

import net.gray.spiceoflifemod.SpiceOfLifeMod;
import net.gray.spiceoflifemod.blocks.custom.MagicBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, SpiceOfLifeMod.MOD_ID);
